...
void autosequence()
{
    ...
    case 0x4: // Fine search - forward
        ...
        printf("Fine search - forward %d\n", track);
        break;
    case 0x5: // Fine search - reverse
        track = track - jump_track;
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("Fine search - reverse %d\n", track);
        break;
    ...
    case 0x8: // 1 Track Jump - forward
        ...
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("1 Track Jump - forward %d\n", track);
        break;
    case 0x9: // 1 Track Jump - reverse
        track = track - 1;
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("1 Track Jump - reverse %d\n", track);
        break;
    ...
    case 0xA: // 10 Track Jump - forward
        ...
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("10 Track Jump - forward %d\n", track);
        break;
    case 0xB:
        track = track - 10; // 10 Track Jump - reverse
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("10 Track Jump - reverse %d\n", track);
        break;
    ...
    case 0xC: // 2N Track Jump - forward
        ...
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("2N Track Jump - forward %d\n", track);
        break;
    case 0xD: // 2N Track Jump - reverse
        track = track - (2 * jump_track);
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("2N Track Jump - reverse %d\n", track);
        break;
    ...
    case 0xE: // M Track Move - forward
        ...
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("M Track Move - forward %d\n", track);
        break;
    case 0xF: // M Track Move - reverse
        track = track - jump_track;
        sector = track_to_sector(track);
        sector_for_track_update = sector;
        printf("M Track Move - reverse %d\n", track);
        break;
    ...
    /*case 0x0: // Cancel
        ...
        sleep_us(cancel_timer_value);
        printf("Cancel - delay %d\n", cancel_timer_value);
        break;*/
